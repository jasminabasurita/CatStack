...
function create() {
  ...
  var panel
  slickUI.add(
    (panel = new SlickUI.Element.Panel(8, 8, game.width - 16, game.height - 16))
  )
  panel
    .add(
      new SlickUI.Element.Text(
        10,
        10,
        "Control the image's opacity by moving the slider"
      )
    )
  ...
  panel.add(
    new SlickUI.Element.DisplayObject(
      panel.width / 2,
      panel.height / 2 + 50,
      previewSprite
    )
  ...
  var sliderVertical = new SlickUI.Element.Slider(
    game.width - 64,
    130,
    game.height - 178,
    0.5,
